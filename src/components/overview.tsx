        ...
        <div className="flex flex-col max-w-4xl mx-auto px-6 gap-8 items-center pb-12">
          <div className="flex-1 space-y-6">
            <p className="text-lg leading-relaxed mb-6">
              ...
              the treatment process. Together, we&apos;ll create a space where
              you feel seen, supported, and empowered to take charge of your
              health. I also believe that treatment should educate as much as it
              heals. Understanding why something hurts is just as important as
              how we fix it. Through open communication, body awareness, and
              individualized strategies, I aim to help you not only recover—but
              thrive. My hope is that each patient walks away not only feeling
              better, but with a deeper understanding of their body and the
              tools to support their long-term health.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="flex w-full flex-col text-center md:w-1/3">
            ...
            <p className="text-muted-foreground">
              We don&apos;t just chase symptoms. I take the time to understand
              your full health picture—from past injuries and chronic pain to
          ...
          <div className="mt-4 md:mt-2 text-center">
            ...
            <div className="mt-8 p-6">
              ...
              <p className="text-center text-muted-foreground leading-relaxed">
                I&apos;m a cash-based, fee-for-service provider. Payment is due
                at each visit, and I can give you a superbill to submit for
                FSA/HSA or possible out-of-network reimbursement. Please note
                that I am not contracted with insurance plans, and reimbursement
                is dependent on your individual policy.
              </p>
            </div>
          </div>
        </div>
